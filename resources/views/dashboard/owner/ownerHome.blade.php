	            ...
	            <div class="card-body">
	              <div class="row">
	                <div class="col-8 text-white">
	                  ...
	                  <a class="btn btn-light" type="button" href="{{ route('owner.property.create') }}">Add Property</a>
	                </div>
	            ...
	            <div class="card-body">                     
	              <div class="row">
	                <div class="col-8 text-white">
	                  ...
	                  <a class="btn btn-light" type="button" href="{{ route('owner.feedback')}}">Feedback</a>
	                </div>
        	...
        	<div class="card data-icon-card-primary card-dark-blue">
	            <div class="card-body">                 
	              <div class="row">
	                <div class="col-8 text-white">
	                  <h3 class="card-title text-white">Properties</h3>
	                  <a class="btn btn-light" type="button" href="">Add Property</a>
	                </div>
