              ...
              <table id="example" class="table display expandable-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="px-2" href="{{ route('owner.property.edit', encrypt($properties->id)) }}">
                        <i class="fa fa-edit fa-lg text-dark"></i></a>
                      <a class="px-2" href="{{ route('owner.property.show', encrypt($properties->id)) }}"><i class="fa fa-file fa-lg"></i></a>
                      <a class="px-2" onclick="event.preventDefault();
                            document.getElementById('delete-property{{$properties->id}}').submit();">
                            <i class="fa fa-trash fa-lg text-danger" aria-hidden="true"></i>
                        </a>
                        <form id="delete-property{{$properties->id}}" action="{{ route('owner.property.destroy', encrypt($properties->id)) }}" method="POST" >
