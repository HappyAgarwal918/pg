...
class brokerPropertyController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('dashboard.broker.property.create', compact('tenants'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($user){
            ...
            if( !$mail->send() ) {
                return redirect()->route('broker.property.index')->with('successful_message', 'Property created successfully & Email not sent.');
            }
              
            else {
                return redirect()->route('broker.property.index')->with('successful_message', 'Property created successfully & Email has been sent.');
            }
        }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.broker.property.edit', compact('data', 'tenants'));
    }
